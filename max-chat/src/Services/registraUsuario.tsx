...
async function RegistraUsuario({email, senha, nome, imagem, contatos}: Cadastro){
    ...
    const resultado = await conectApi.cadastraUsuario({email, nome, senha, imagem, contatos});
